...
- [Use Cases](#usecases)
- [The Key Idea](#idea)
- [Benefits of MetaFast](#results)
- [Using MetaFast](#usage)
...
make rm -C MetaFast/ReadMapping
```
...
python3 MetaFast.py <reads.fq> <Ref_DB> --output profile.tsv
...
[M::start] CMD: ./minimap2 -n 3 -t 1 /home/arvidg/git/MetaFast/Data/RefData/test/test.mmi /home/arvidg/git/MetaFast/Data/ReadSets/test.fastq
...
len is 833
/home/arvidg/git/MetaFast/ReproducibleEvaluation/Results/MetaFast/ContainmentResults.csv
...
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=base-counting --secondary=yes ../ReproducibleEvaluation/Results/MetaFast/subset_db.fna ../Data/ReadSets/test.fastq
[M::main] Real time: 10.434 sec; CPU: 7.995 sec; Peak RSS: 0.159 GB
</pre>
</details>

<details>
<summary>MetaFast by Stages</summary>
<pre>
./MetaFast-Stages.sh 
<br>
=======================================================  RUNNING STAGE 1: Containment Search  ======================================================
<br>
Found -n 3?, -b set 0?, mmi /home/arvidg/git/MetaFast/Data/RefData/test?, reads /home/arvidg/git/MetaFast/Data/ReadSets/test.fastq?, tr /home/arvidg/git/MetaFast/Data/RefData/test/translate/translate_sorted.csv?, out /home/arvidg/git/MetaFast/ReproducibleEvaluation/Results/ContainmentSearch/ContainmentResults.csv?
fCnt is 1
Creating thread 0
[WARNING] Indexing parameters (-k, -w or -H) overridden by parameters used in the prebuilt index.
...
merging 1 queues (REACHED)
len is 833
/home/arvidg/git/MetaFast/ReproducibleEvaluation/Results/ContainmentSearch/ContainmentResults.csv
<br>
=======================================================  DONE STAGE 1 ======================================================
<br>
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=hd --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=adjacency-filter --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=base-counting --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=magnet --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=qgram --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=shd --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=shouji --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=sneakysnake --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=edlib --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=grim_original --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
[M::main] Version: 2.17-r974-dirty-SneakySnake
[M::main] CMD --SneakySnake-- : ../MetaFast/ReadMapping/rm -ax sr -t 1 -2 -n 3 -r 15 --filter=grim_original_tweak --sam-hit-only --secondary=yes Results/ContainmentSearch/subset_db.fna ../Data/ReadSets/test.fastq
...
**B.** Instructions on how to obtain the reference genomes and RefSeq database from our evaluation. We also provide a prebuilt index to test MetaFast immediately.
2. MetaFast  
**A.** The source code of our containment search (first stage of MetaFast) implementation.  
**B.** The source code of our alignment-free read mapping (second stage of MetaFast) implementation.  
**C.** The source code of the complete MetaFast pipeline.
3. ReproducibleEvaluation  
We provide shell scripts and commands used to run the experimental evaluations presented in the paper. We further provide a script to run and test each stage of MetaFast individually. We store the output of each stage under A., B., and C., respectively.
4. RawResults  
